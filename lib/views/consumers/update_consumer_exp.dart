...
class _EditDialogState extends State<EditDialog> {
  ...
  void initState() {
    ...
    //print("Pole Detail: ${widget.consumer.poleDetailsId}");
    ...
    print("selectedTariffCategoryId: ${widget.consumer.tariffCategoryId}");
    if (widget.consumer.tariffCategoryId != null &&
        widget.consumer.tariffCategoryId != 0) {
      selectedTariffCategoryId = widget.consumer.tariffCategoryId;
    }

    if (widget.consumer.tariffSubCategoryId != null &&
        widget.consumer.tariffSubCategoryId != 0) {
      selectedTariffSubCategoryId = widget.consumer.tariffSubCategoryId;
    }

    selectedMeterTypeId = (widget.consumer.meterTypeId != null &&
            widget.consumer.meterTypeId != 0)
        ? widget.consumer.meterTypeId
        : selectedMeterTypeId;

    selectedPhasingCodeId = (widget.consumer.phasingCodeTypeId != null &&
            widget.consumer.phasingCodeTypeId != 0)
        ? widget.consumer.phasingCodeTypeId
        : selectedPhasingCodeId;

    selectedConnectionStatusId = (widget.consumer.connectionStatusId != null &&
            widget.consumer.connectionStatusId != 0)
        ? widget.consumer.connectionStatusId
        : selectedConnectionStatusId;

    selectedConnectiontypeId = (widget.consumer.connectionTypeId != null &&
            widget.consumer.connectionTypeId != 0)
        ? widget.consumer.connectionTypeId
        : selectedConnectiontypeId;

    selectedLocationId =
        (widget.consumer.locationId != null && widget.consumer.locationId != 0)
            ? widget.consumer.locationId
            : selectedLocationId;

    selectedServiceCableId = (widget.consumer.serviceCableTypeId != null &&
            widget.consumer.serviceCableTypeId != 0)
        ? widget.consumer.serviceCableTypeId
        : selectedServiceCableId;

    selectedDTId = (widget.consumer.dtId != null && widget.consumer.dtId != 0)
        ? widget.consumer.dtId
        : selectedDTId;

    selectedOperatingVoltage = (widget.consumer.operatingVoltageId != null &&
            widget.consumer.operatingVoltageId != 0)
        ? widget.consumer.operatingVoltageId
        : selectedOperatingVoltage;

    selectedBusinessType = (widget.consumer.businessTypeId != null &&
            widget.consumer.businessTypeId != 0)
        ? widget.consumer.businessTypeId
        : selectedBusinessType;

    selectedStructureType = (widget.consumer.structureTypeId != null &&
            widget.consumer.structureTypeId != 0)
        ? widget.consumer.structureTypeId
        : selectedStructureType;

    if (widget.consumer.installDate != "") {
      ...
      _installDateController =
          TextEditingController(text: widget.consumer.installDate);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String sanctionedLoadValue =
        widget.consumer.sanctionedLoad.toString();
    final String? sanctionedLoad =
        (sanctionedLoadValue == '0' || sanctionedLoadValue == '0.0')
            ? null
            : sanctionedLoadValue;
    final TextEditingController _sanctionedLoadController =
        TextEditingController(text: sanctionedLoad);
    ///////////////--- Making Sanction Load Null ---/////////////////////
    ...
    final String? connectedLoad =
        (connectedLoadValue == '0' || connectedLoadValue == '0.0')
            ? null
            : connectedLoadValue;
    final TextEditingController _connectedLoadController =
        TextEditingController(text: connectedLoad);
    ///////////////--- Making Connection Load Null ---/////////////////////
    ///
    ...
    final String? meterReading =
        (meterReadingValue == '0' || meterReadingValue == '0.0')
            ? null
            : meterReadingValue;
    final TextEditingController _meterReadingController =
        TextEditingController(text: meterReading);
    ///////////////--- Making Meter Reading Null ---/////////////////////
    ...
    final String? floorNo =
        (floodNoValue == '0' || floodNoValue == '0.00') ? null : floodNoValue;
    final TextEditingController _numberOfFloorController =
        TextEditingController(text: floorNo);
    ///////////////--- Making Number of Floor Null ---/////////////////////
    ///
    ...
    final String? controllerText =
        (feederUIdValue == '0' || feederUIdValue == '0.00')
            ? null
            : feederUIdValue;
    final TextEditingController _feederUId =
