                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // "circleId"
                                    Text(
                                        'Circle: ${detailedFeederLine.circleId}'),
                                    const Divider(),
                                    // "sndId"
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    // "feederLineId"
                                    Text(
                                      "Feeder Line Id: ${detailedFeederLine.feederLineId.toString()}",
                                    ...
                                    // "isGrid"
                                    Text(
                                        'Is Grid: ${detailedFeederLine.isGrid}'),
                                    const Divider(),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // "peakDemand"
                                    Text(
                                        'Peak Demand: ${detailedFeederLine.peakDemand}'),
                                    const Divider(),
                                    // "maximumLoad"
                                    Text(
                                        'Maximum Load: ${detailedFeederLine.maximumLoad}'),
                                    const Divider(),
                                    // "sanctionedLoad"
                                    Text(
                                    ...
                                    // "isPgcbGrid"
                                    Text(
                                        'Is Pgcb Grid: ${detailedFeederLine.isPgcbGrid}'),
                                    const Divider(
                                      color: Colors.transparent,
                                    ),
                                  ],
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    // "remarks"
                                    Text(
                                        'Remarks: ${detailedFeederLine.remarks}'),
                                    const Divider(
                                      color: Colors.transparent,
                                    ),
                                  ],
...
Future<bool?> showDeleteConfirmationDialog(BuildContext context) {
  return showDialog<bool>(
    ...
    builder: (context) => AlertDialog(
      ...
      content: const Text(
          'Are you sure you want to delete this Feeder Line Information?'),
      actions: [
        TextButton(
