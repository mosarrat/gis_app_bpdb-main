...
class FilterPoleBySnd extends StatefulWidget {
  const FilterPoleBySnd({super.key});

  @override
  _FilterPoleBySndState createState() => _FilterPoleBySndState();
}

class _FilterPoleBySndState extends State<FilterPoleBySnd> {
